...
@Slf4j
@RepositoryUnitTest
@DisplayName("통합테스트 - RawRestaurantWriter")
class RawRestaurantWriterIntegretionTest {
    ...
    void writeOne() throws CustomException {
        ...
        //than
        Assertions.assertThat((raw1.getId())).isNotNull(); // raw1은 저장되었으므로 not null
        Assertions.assertThat((raw2.getId())).isNull(); // raw2는 저장되지 않았으므로 null
